...
**For CI-driven deploys:**

- **`mcp-app-github-actions`** — dispatch a GitHub Actions workflow
  and wait for completion, parse the run for the deployed URL.
  Config: workflow filename, ref, inputs, wait-mode.
